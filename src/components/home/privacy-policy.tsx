  ...
  <HomeContainer>
    <NarrowContainer>
      ...
      <Box my={4}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Reportal.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Reportal, accessible from{" "}
              <a href="https://reportal.lukasbach.com" rel="external nofollow noopener noreferrer" target="_blank">
                https://reportal.lukasbach.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: contact@lukasbach.com</li>
        </ul>
      </Box>
    </NarrowContainer>
  </HomeContainer>
